...
##Nous avons deux hypothèses pour le test de Breusch Godfrey
...
##en réalisant le test, on constate que nous avons une p-value = 3.43x10E(-6) inf�rieur au 5%, c'est à dire qu'on rejete l'hypothèse h0,
## et que la s�rie ne pr�sente pas de cas d'homosc�dasticit� mais que sa variance varie au cours du temps
