...
fit <- estimate(diff_premiere, p=5,d=0,q=3) #AIC -1239.748 meilleure modèle
...
library(aTSA)
estimate(diff_premiere,p=1,d=0,q=4) ##aic = 1240.121 toutes les p-value sont significatives < 5% et t-value 
estimate(diff_premiere,p=1,d=0,q=3) ##aic = 1241.118
estimate(diff_premiere,p=2,d=0,q=3) ##aic = 1239.803
estimate(diff_premiere,p=2,d=1,q=1) ##aic = 1238.291
...
arima(diff_premiere, order = c(2,1,3)) ##on test un modèle ARIMA tel que AR=2 et MA=3 #-1236.91
arima(diff_premiere, order = c(2,1,4)) ##on test un modèle ARIMA tel que AR=2 et MA=3 #-1237.39
arima(diff_premiere, order = c(2,1,2)) ##on test un modèle ARIMA tel que AR=2 et MA=3 #-1236.55 
arima(diff_premiere, order = c(2,1,5)) ##on test un modèle ARIMA tel que AR=2 et MA=3 #-1232.73
arima(diff_premiere, order = c(2,1,6)) ##on test un modèle ARIMA tel que AR=2 et MA=3 #-1230.88 
arima(diff_premiere, order = c(2,1,7)) ##on test un modèle ARIMA tel que AR=2 et MA=3 #-1228.89
arima(diff_premiere, order = c(2,1,8)) ##on test un modèle ARIMA tel que AR=2 et MA=3 #-1226 meilleur modèle
##on peut regarder la t-value de nos AR et MA pour voir s'ils sont significatifs
#-0.3391/0.7440 = -0.45
